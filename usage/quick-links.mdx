---
title: "Quick-Link Buttons in the amongGX Toolbar"
sidebarTitle: "Quick Links"
description: "Among GX includes four one-click quick-link buttons for Discord, YouTube, the Among Us Steam page, and the creator's channel — here's where each one goes."
---
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://www.discord.com">
    **Label:** `Discord`  
  ...
  <Card title="Music (♫)" icon="music" href="https://www.youtube.com/watch?v=8-NcrRzH0vA">
    **Label:** `♫`  
  ...
  <Card title="Among Us Store (ඞ)" icon="store" href="https://store.steampowered.com/app/945360/Among_Us/">
    **Label:** `ඞ`  
  ...
  <Card title="Subscribe (👍)" icon="thumbs-up" href="https://www.youtube.com/channel/UClDPJcyKnwUiAX1UQgZgoAw">
    **Label:** `👍`  
